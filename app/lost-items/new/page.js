                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <input type="date" className="glass-input" value={form.dateLost} onChange={change('dateLost')} required />
                            </div>
                            <div className="space-y-1.5">
                        ...
                        {/* Location */}
                        <div className="space-y-1.5">
                            <label className="text-xs text-white/60 uppercase tracking-wide">Possible Location *</label>
